#import "/sty/abnt-paper.typ": jmlr
...
#show: jmlr.with(
  ...
  pubdata: (
    ...
    editor: "My editor",
    volume: 23,
    submitted-at: datetime(year: 2024, month: 11, day: 1),
    revised-at: datetime(year: 2024, month: 11, day: 10),
    published-at: datetime(year: 2024, month: 11, day: 13),
  ),
)
